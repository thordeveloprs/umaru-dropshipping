                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      ...
                      children: [
                        Builder(
                          builder: (context) {
                            final ordersChildren = List.generate(
                            ...
                            return ListView.builder(
                              ...
                              itemBuilder: (context, ordersChildrenIndex) {
                                final ordersChildrenItem =
                                    ordersChildren[ordersChildrenIndex];
                                return Padding(
