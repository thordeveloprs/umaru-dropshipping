                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      ...
                      children: [
                        Builder(
                          builder: (context) {
                            final orderChildren = List.generate(
                            ...
                            return ListView.builder(
                              ...
                              itemCount: orderChildren.length,
                              itemBuilder: (context, orderChildrenIndex) {
                                final orderChildrenItem =
                                    orderChildren[orderChildrenIndex];
                                return Padding(
